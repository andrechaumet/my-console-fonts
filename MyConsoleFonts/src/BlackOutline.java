...
public class BlackOutline {
	...
	private void sample(String name) {
		...
		for (int i = 0; i < name.length(); i++) {
			floor3 += conversorLetra3(name.charAt(i));
		}
		for (int i = 0; i < name.length(); i++) {
			floor4 += conversorLetra4(name.charAt(i));
		}
		for (int i = 0; i < name.length(); i++) {
			floor5 += conversorLetra5(name.charAt(i));
		}
		for (int i = 0; i < name.length(); i++) {
			floor6 += conversorLetra6(name.charAt(i));
		}
		for (int i = 0; i < name.length(); i++) {
			floor7 += conversorLetra7(name.charAt(i));
		}
		...
		System.out.println(floor6);
		System.out.println(floor7);
	...
	private String conversorLetra2(char letra) { // 2/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a2;
	...
	private String conversorLetra3(char letra) { // 3/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a3;
	...
	private String conversorLetra4(char letra) { // 4/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a4;
	...
	private String conversorLetra5(char letra) { // 5/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a5;
	...
	private String conversorLetra6(char letra) { // 6/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a6;
	...
	private String conversorLetra7(char letra) { // 7/7
		String diseno = "";
		switch (letra) {
		case 'a':
			diseno = a7;
